...
export default function AdditionsDespatchPage() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh]">
        ...
        <div className="flex gap-4">
          <button onClick={() => router.push(`/supplier/${slug}/additions`)} className="px-8 py-3 rounded bg-accent text-white font-bold text-lg hover:bg-accent-light transition">Back to Additions</button>
