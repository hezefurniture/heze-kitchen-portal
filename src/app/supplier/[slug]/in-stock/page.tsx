              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  {isComplete ? (
                    ...
                    <div className="w-12 h-12 bg-yellow-500 rounded flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
                    </div>
                  )}
                  <div>
                ...
                <div className="flex items-center gap-2">
                  {isComplete ? (
                    ...
                    <Link href={`/supplier/${slug}/in-stock/${order.id}/scan-extra`} className="bg-card-light hover:bg-gray-500 text-white font-bold px-6 py-3 rounded transition text-lg">Scan Extra</Link>
                  )}
